// app-core.js — Configuração, utils, cloud, receitas, navegação
// ⛔ ZONA CRÍTICA: não editar funções de cloud e utils sem cuidado
// ═══════════════════════════════════════════
// MÓDULOS INCLUÍDOS:
//   CONFIG & STATE | UTILS | CLOUD | DATA MAPPING
//   NAVIGATION | RENDER HOME | RENDER RECIPES
//   NEW RECIPE FLOW | EDIT FORM | SAVE RECIPE | VIEW RECIPE | SHARE PAGE | INIT
// ═══════════════════════════════════════════
...
// CLOUD: LOAD
// ═══════════════════════════════════════════
// getCurrentRole() — declarada em app-features.js
// isLoggedIn() — declarada em app-features.js
// isGuest() — declarada em app-features.js
